...
if (UNIX AND NOT APPLE)
  set(_INCLUDE_DIR_BULLET "${BULLET_ROOT}/include/bullet")
elseif(APPLE)
  set(_INCLUDE_DIR_BULLET "${BULLET_ROOT}/include")
endif()


find_path(BULLET_INCLUDE_DIR NAMES btBulletCollisionCommon.h
  PATHS "${_INCLUDE_DIR_BULLET}")

find_path(DYNAMICS_INCLUDE_DIR NAMES btBulletDynamicsCommon.h
  PATHS "${_INCLUDE_DIR_BULLET}/BulletDynamics/")

find_path(SOFTBODY_INCLUDE_DIR NAMES btSoftBody.h
  PATHS "${_INCLUDE_DIR_BULLET}/BulletSoftBody")
...
set(BULLET_INCLUDE_DIRS ${BULLET_INCLUDE_DIR} ${DYNAMICS_INCLUDE_DIR} ${SOFTBODY_INCLUDE_DIR})
